...
object TopMonthSegment : DomSegment {
    override var source: Source = HocVienTruyenTranhSource
    override var pathName: String = "Top month"
    ...
    override var urisSelector: String = ".ctd-tabs.ranking>.tab-content>#top-month>table>tbody>tr>td:nth-child(2)>a"
    override var urisAttribute: String = "href"
    override var titlesSelector: String = ".ctd-tabs.ranking>.tab-content>#top-month>table>tbody>tr>td:nth-child(2)>a"
